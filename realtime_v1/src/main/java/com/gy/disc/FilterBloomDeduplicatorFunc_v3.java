 ...
 * @description: 布隆过滤器
 */
public class FilterBloomDeduplicatorFunc_v3 extends RichFilterFunction<JSONObject> {

    private static final Logger logger = LoggerFactory.getLogger(FilterBloomDeduplicatorFunc_v3.class);

    private final int expectedInsertions;
    private final double falsePositiveRate;
    private transient ValueState<byte[]> bloomState;

    public FilterBloomDeduplicatorFunc_v3(int expectedInsertions, double falsePositiveRate) {
