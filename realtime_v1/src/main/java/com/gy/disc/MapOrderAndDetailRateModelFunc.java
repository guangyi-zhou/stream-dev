...
import com.gy.disc.domain.DimSkuInfoMsg;
...
public class MapOrderAndDetailRateModelFunc extends RichMapFunction<JSONObject,JSONObject> {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        String querySkuSql = "select sku_info.id as skuid,      \n" +
                        ...
                        "from stream_retail.sku_info              \n" +
                        "join stream_retail.spu_info              \n" +
                        "on sku_info.spu_id = spu_info.id       \n" +
                        "join stream_retail.base_trademark        \n" +
                        "on stream_retail.spu_info.tm_id = stream_retail.base_trademark.id";
