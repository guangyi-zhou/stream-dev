...
public class SiliconFlowApi {
    ...
    private static final String SILICON_API_TOKEN = "sk-iciadbchluzaxyhwpoamuabzbuwmmazgkrqdellxmgpzbjtf";
    ...
    public static String generateBadReview(String prompt, String apiToken) {
        try {
            ...
            Request request = new Request.Builder()
                    ...
                    .addHeader("Authorization", "Bearer " + "sk-iciadbchluzaxyhwpoamuabzbuwmmazgkrqdellxmgpzbjtf")
