...
local_file_path = 'E:\\LoadWork\\common-config.properties.local'
target_file_path = 'E:\\workspace\\stream-dev\\stream-common\\src\\main\\resources\\filter\\common-config.properties.prod'
